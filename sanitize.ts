import { sanitizeTurnBlobsForProfile } from './attachments.ts';
...
function sanitizeFix(fix: import('./types.ts').TurnFixRequest | undefined): import('./types.ts').TurnFixRequest | undefined {
  if (!fix) {
    return fix;
  }
  return {
...
function sanitizeHistory(
  history: import('./types.ts').TurnHistoryMessage[] | undefined,
): import('./types.ts').TurnHistoryMessage[] | undefined {
  if (!history) {
    return history;
  }
